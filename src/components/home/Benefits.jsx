...
const benefits = [
  ...
  },
  {
    ...
    description: "Built by Indian innovators for Indian businesses - faster, compliant, efficient.",
  ...
  return (
    <section className="py-20 px-4 bg-gradient-to-br from-white via-gray-50 to-orange-50/20 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8" data-stagger-parent data-stagger="0.1" data-stagger-duration="0.7" data-stagger-offset="40" data-stagger-type="card">
