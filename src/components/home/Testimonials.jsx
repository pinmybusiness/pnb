...
const testimonials = [
  {
    quote: "As a bootstrapped founder juggling everything, Trackly's auto-logging just clicked -caught a missed client call from last week that turned into our biggest deal yet. No more scribbling notes mid-chaos!",
    author: "Kunal Mehta",
    role: "Founder",
    company: "AdBoost Media",
  },
  {
    quote: "In real estate, leads vanish if you blink. Trackly's WhatsApp alerts pinged me about a hot inquiry right after it dropped -closed the viewing same day. Feels like having an extra rep on the team.",
    author: "Nisha Patel",
    role: "Property Consultant",
    company: "HomeVista Realty",
  },
  {
    quote: "Freelancing means wearing all hats, and call tracking was my weak spot. Trackly syncs everything to my Zoho CRM without a fuss -now I invoice faster and chase payments like clockwork. Total lifesaver for solopreneurs.",
    author: "Ravi Kumar",
    role: "Freelance Marketer",
    company: "Self-employed",
  },
  {
    quote: "With our lean sales squad, I needed eyes on every call without micromanaging. Trackly's daily WhatsApp recaps give me the highlights -team's hit rate jumped 20% in the first month. Simple, smart, and stupidly effective.",
    author: "Rajesh Kumar",
    role: "Sales Manager",
    ...
    <section className="py-20 px-4  relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="mt-16 hidden md:grid grid-cols-3 gap-8 max-w-4xl mx-auto">
          {[{ number: "200+", label: "Active Users" }, { number: "4.9/5", label: "Average Rating" }, { number: "98%", label: "Would Recommend" }].map((stat, i) => (
