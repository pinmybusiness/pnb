...
import { getStipendText, getOpportunityTypeText, getInternshipTypeText } from "@/utils/opportunity";
    ...
    >
       ...
       {/* Applied count */}
        {/* {opportunity.applications?.length > 0 && (
          <div className="w-18 text-center ">
            <span className="flex flex-wrap gap-1 p-1 items-center text-[10px] sm:text-xs text-gray-500 bg-gray-50 px-2 rounded-xl">
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="flex items-center gap-3 text-sm text-gray-500">
          ...
          <span>
            {opportunity.branch?.location?.city?.name || "Unknown Location"}
          </span>
        </div>
